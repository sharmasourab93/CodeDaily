...
class E:
    ...
    def write_youtube(self,a,url):
        ...
        a.write('<iframe width="800" height="500" src="https://youtube.com/embed/'+url+'?autoplay=1&loop=1" frameborder="0" style="position:absolute">')

    def write_kaltura(self,a,url):
        """Write Kaltura Videos to the HTML Files"""
        #Change the ConfId in the code
        a.write('<iframe width="800" height="500" src="https://play.ericsson.net/embed/secure/iframe/entryId/'+url+'/uiConfId/22936291" frameborder="0" style="position:absolute">')
