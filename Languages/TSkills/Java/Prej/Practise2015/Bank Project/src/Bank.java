...
public class Bank {
	...
	public String createAccount(Bank objBank){
		...
		try{
		pst=con.prepareStatement("insert into accounts(AccountNo,FirstName,LastName,"+" city,state,amount,cheqfacil,AccountType)values(?,?,?,?,?,?,?,?)");
		pst.setInt(1, objBank.generateAccountNo());
